...
| **Admin rights** | **Not required** — Tesseract is installed to `%LOCALAPPDATA%\Programs\Tesseract-OCR` |
...
Open the **🤖 AI Context** tab and fill in:
- **Meeting Title** — e.g. `Project Update Q2` (used in filenames and the AI prompt)
- Optional: Job Title, Company, Department (enrich the AI prompt with your context)
